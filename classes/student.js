...
class Student extends User {
    ...
    getCourse() {
      return currentDate.getFullYear() - this.year;       //извлекаем текущий год из текущей даты, вычитаем год поступления, возвращаем результат
    }
}

const currentDate = new Date();                           //объект содержащий текущую дату
